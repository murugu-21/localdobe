              ...
              >
                {autoFixed.has(i) && (
                  <span
                    ...
                    className="absolute top-1 left-1 z-10 inline-flex items-center gap-1 rounded-full bg-primary px-2 py-0.5 text-[0.65rem] font-semibold text-primary-foreground"
                  >
